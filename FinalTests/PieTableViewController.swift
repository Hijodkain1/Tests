...
class PieTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.backBarButtonItem = UIBarButtonItem(title: "Pie", style: .plain, target: nil, action: nil)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellID = "PieTestCell"
        
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! PieTableViewCell
        cell.nameLabel.text = elTestDeLaCelda.name
        /*el "text" del "nameLabel" de la "cell" tiene que ser igual al "name" de elTestDeLaCelda*/
