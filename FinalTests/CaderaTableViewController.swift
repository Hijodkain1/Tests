//
//  CaderaTableViewController.swift
//  FinalTests
//
...
class CaderaTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.backBarButtonItem = UIBarButtonItem(title: "Cadera", style: .plain, target: nil, action: nil)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellID = "CaderaTestCell"
        
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! CaderaTableViewCell
