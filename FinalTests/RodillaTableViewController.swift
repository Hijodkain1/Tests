//
//  RodillaTableViewController.swift
//  FinalTests
//
...
class RodillaTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.backBarButtonItem = UIBarButtonItem(title: "Rodilla", style: .plain, target: nil, action: nil)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellID = "RodillaTestCell"
        
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! RodillaTableViewCell
